...
namespace NetworkTables.Test.NetworkTables
{
    ...
    public class NetworkTableListenerTest
    {
        ...
        private static NetworkTableManaged testTable1;
        static private NetworkTableManaged testTable2;
        static private NetworkTableManaged testTable3;
        static private NetworkTableManaged testSubTable1;
        static private NetworkTableManaged testSubTable2;
        static private NetworkTableManaged testSubTable3;
        static private NetworkTableManaged testSubTable4;
        ...
        public static void Init()
        {
            ...
            testTable1 = (NetworkTableManaged)provider.GetTable("/test1");
            testTable1 = (NetworkTableManaged)provider.GetTable("/test1");
            testTable2 = (NetworkTableManaged)provider.GetTable("/test2");
            testSubTable1 = (NetworkTableManaged)provider.GetTable("/test2/sub1");
            testSubTable2 = (NetworkTableManaged)provider.GetTable("/test2/sub2");
            testTable3 = (NetworkTableManaged)provider.GetTable("/test3");
            testSubTable3 = (NetworkTableManaged)provider.GetTable("/test3/suba");
            testSubTable4 = (NetworkTableManaged)provider.GetTable("/test3/suba/subb");
        }
