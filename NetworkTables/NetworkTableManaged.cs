...
{
    /// <summary>
    /// This class is the Main Class for interfacing with NetworkTables. Note that this is based on the NT 2.0 Protocol and uses all managed code.
    /// </summary>
    ...
    /// <code language="cs">
    /// //Set Server Mode
    /// ManagedNetworkTable.SetServerMode();
    /// 
    /// //Initialize the Server
    /// ManagedNetworkTable.Initialize();
    /// 
    /// //Get a reference to the smartdashboard.
    /// var smartDashboard = ManagedNetworkTable.GetTable("SmartDashboard");
    /// </code>
    ...
    /// ManagedNetworkTable.SetIPAddress("roborio-xxxx.local");
    /// 
    /// //Set Client Mode
    /// ManagedNetworkTable.SetClientMode();
    /// 
    ...
    /// </code>
    /// </example>
    public class NetworkTableManaged : ITable, IRemote
    {
        ...
        internal NetworkTableManaged(string path, NetworkTableProvider provider)
        {
            this.path = path;
        ...
        internal class NetworkTableKeyCache : StringCache
        {
            ...
            {
                return path + NetworkTable.PATH_SEPERATOR_CHAR + key;
            }
        }
        ...
        public void AddTableListener(ITableListener listener, bool immediateNotify)
        {
            ...
            NetworkTableListenerAdapter adapter = new NetworkTableListenerAdapter(path + NetworkTable.PATH_SEPERATOR_CHAR, this, listener);
        ...
        {
            string subtablePrefix = absoluteKeyCache.Get(key) + NetworkTable.PATH_SEPERATOR_CHAR;
