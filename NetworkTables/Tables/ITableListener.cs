namespace NetworkTables.Tables
{
    ...
    public interface ITableListener
    {
        ...
        /// </summary>
        /// <param name="source">The table the key-value pair exists in.</param>
        /// <param name="key">The key associated with the value that changed</param>
        /// <param name="value">The new value</param>
        /// <param name="isNew">Ture if the key did not previously exist in the table, otherwise it is false.</param>
