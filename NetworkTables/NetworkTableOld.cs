...
namespace NetworkTables
{
    ...
    /// </code>
    /// </example>
    public class NetworkTableOld : ITable, IRemote
    {
        ...
        /// <returns>The <see cref="NetworkTableOld"/> requested.</returns>
        public static NetworkTableOld GetTable(string key)
        {
            lock (s_lockObject)
            {
                if (s_staticProvider == null)
                ...
                return (NetworkTableOld)s_staticProvider?.GetTable(PATH_SEPARATOR + key);
            }
        }
        ...
        internal NetworkTableOld(string path, NetworkTableProvider provider)
        {
            this.path = path;
